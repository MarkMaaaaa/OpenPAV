...
from dataPreprocessing_M2_global import dataSelection_simplified, trajectory_predict_M2_global
...
def objective_func_simplified(para_list, df_selected_list = df_selected_list_):
    ...
    for df_selected_ in df_selected_list:
        df_results = trajectory_predict_M2_global(para_list, df_selected_)
